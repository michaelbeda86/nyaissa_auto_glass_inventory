...
@section('content')
    <div class="max-w-4xl mx-auto bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
        ...
        <div class="flex justify-end mb-4">
            <a href="{{ route('products.create') }}" class="bg-blue-600 text-white py-2 px-4 rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 transition duration-300">Add Product</a>
        </div>
            ...
            <table class="min-w-full bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700">
                <thead>
                    <tr class="border-b border-gray-300 dark:border-gray-700">
                        ...
                        <th class="py-2 px-4 text-left text-gray-700 dark:text-gray-300">Category</th>
                        <th class="py-2 px-4 text-left text-gray-700 dark:text-gray-300">Unit Price</th>
                ...
                <tbody>
                    @foreach ($products as $product)
                        <tr class="border-b border-gray-300 dark:border-gray-700">
                            ...
                            <td class="py-2 px-4 text-gray-800 dark:text-gray-200">{{ $product->category }}</td>
                            <td class="py-2 px-4 text-gray-800 dark:text-gray-200">Tshs {{ $product->formatted_unit_price }}</td>
